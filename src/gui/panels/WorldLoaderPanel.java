...
class WorldLoaderPanel extends GPanel implements ControlListener
{
    ...
    private final Button newWorld = new Button ("CREATE", 400, 540, 200, 20, new Color (60, 60, 60), () -> {
        
        this.parent.switchPanel ("Game", "World 1");
    });
    ...
    public void controlOccurred (ControlEvent e)
    {
        ...
        if (e.type == ControlEvent.Type.SCROLL_ITEM_DESELECT) this.select.setDisabled (true);
    }
